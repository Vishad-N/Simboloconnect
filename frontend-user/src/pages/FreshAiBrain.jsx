...
export default function AiBrain() {
    ...
    return (
        <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif" }}>
          <style>{`
            .ab-wrap { background:#f3fbf6!important; color:#0b1e12!important; }
            /* Inner sidebar */
            .ab-sidebar { background:#ffffff!important; border-right:1px solid #cde9d8!important; }
            .ab-sidebar-head { border-bottom:1px solid #e8f5ee!important; }
            /* Nav buttons */
            .ab-nav-btn { color:#4d7a62!important; transition:all .18s; border-radius:9px!important; }
            .ab-nav-btn:hover { background:#f0fdf5!important; color:#0b1e12!important; }
            .ab-nav-btn.ab-active {
              background:linear-gradient(135deg,#25D366,#16a34a)!important;
              color:#ffffff!important;
              box-shadow:inset 2px 0 0 #16a34a!important;
            }
            .ab-nav-btn.ab-active svg {
              color:#ffffff!important;
            }
            /* Content area */
            .ab-content { background:#f3fbf6!important; }
            /* Cards */
            .ab-wrap .bg-surface-900, .ab-wrap .bg-surface-950, .ab-wrap .bg-surface-800 { background:#ffffff!important; border:1px solid #cde9d8!important; }
            .ab-wrap .border-white\/5, .ab-wrap .border-white\/10 { border-color:#cde9d8!important; }
            .ab-wrap .text-white { color:#0b1e12!important; }
            .ab-wrap .text-surface-400, .ab-wrap .text-surface-300, .ab-wrap .text-surface-500 { color:#4d7a62!important; }
            .ab-wrap h1,.ab-wrap h2,.ab-wrap h3,.ab-wrap h4,.ab-wrap h5,.ab-wrap h6 { color:#0b1e12!important; }
            /* Inputs/selects */
            .ab-wrap input,.ab-wrap textarea,.ab-wrap select { background:#f3fbf6!important; border-color:#cde9d8!important; color:#0b1e12!important; }
            .ab-wrap input:focus,.ab-wrap textarea:focus,.ab-wrap select:focus { border-color:#25D366!important; box-shadow:0 0 0 3px rgba(37,211,102,.12)!important; }
            /* Save btn */
            .ab-wrap .bg-brand-500 { background:linear-gradient(135deg,#25D366,#00df6a)!important; color:#fff!important; }
            /* Error type chips active */
            .ab-wrap .bg-brand-500.text-surface-950 { color:#ffffff!important; }
            /* Overflow inside sandbox/logs */
            .ab-wrap .bg-surface-950.rounded-xl, .ab-wrap .bg-surface-950.rounded-lg { background:#f8fefb!important; border:1px solid #e8f5ee!important; }
            /* Toggles */
            .ab-wrap input[type="checkbox"].peer:checked ~ div { background:linear-gradient(135deg,#25D366,#16a34a)!important; }
            .ab-wrap input[type="checkbox"].peer:not(:checked) ~ div { background:#cbd5e1!important; }
          `}</style>
          <div className="ab-wrap" style={{ minHeight:'calc(100vh-80px)', display:'flex', borderRadius:12, overflow:'hidden', border:'1px solid #cde9d8', boxShadow:'0 2px 24px rgba(37,211,102,.08)' }}>
            {/* Inner Sidebar for Tabs */}
            <div className="ab-sidebar" style={{ width:240, display:'flex', flexDirection:'column', flexShrink:0 }}>
                <div className="ab-sidebar-head" style={{ padding:'20px 20px 14px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:4 }}>
                        <div style={{ padding:7, background:'rgba(37,211,102,.1)', borderRadius:9 }}>
                            <Bot style={{ width:20, height:20, color:'#25D366' }} />
                        </div>
                        <h1 style={{ fontSize:17, fontWeight:900, color:'#0b1e12', margin:0 }}>AI Brain</h1>
                    </div>
                    <p style={{ fontSize:11, color:'#4d7a62', marginTop:4, marginLeft:2 }}>Workspace Operating System</p>
                </div>
                <div style={{ flex:1, overflowY:'auto', padding:'10px 10px' }}>
                    {TABS.map(tab => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium ab-nav-btn ${
                                activeTab === tab.id ? 'ab-active' : ''
                            }`}
                            style={{ border: 'none', cursor: 'pointer', textAlign: 'left', background: 'transparent' }}
                        >
            ...
            {/* Main Content Area */}
            <div className="flex-1 p-8 overflow-y-auto ab-content">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        {currentErrorConfig?.suggestions.map((sug, i) => (
                                            <button
                                                ...
                                                className="text-[11px] text-left px-2.5 py-1.5 bg-surface-900 hover:bg-surface-850 border border-white/5 hover:border-brand-500/20 text-surface-300 rounded transition-all truncate"
                                            >
                                                + "{sug}"
                                            </button>
                                        ))}
